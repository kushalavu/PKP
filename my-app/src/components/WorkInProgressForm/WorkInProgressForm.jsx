      ...
      <form onSubmit={handleSubmit}>
        <div className="row mb-3">
          ...
          <div className="col-md-4">
            ...
            <input type="text" name="packed" value={formData.packed} onChange={handleChange} className="form-control frm-input-style"placeholder='Packed' />
          </div>
        </div>
        ...
        <div className="row mb-3">
          <div className="col-md-4">
            ...
            <input type="text" name="forPacking" value={formData.forPacking} onChange={handleChange} className="form-control frm-input-style" placeholder='For packing'/>
          </div>
          <div className="col-md-4">
            <label className="form-label clr-label">Under Packing</label>
            <input type="text" name="underPacking" value={formData.underPacking} onChange={handleChange} className="form-control frm-input-style"placeholder='Under packing' />
          </div>
          <div className="col-md-4">
            <label className="form-label clr-label">For Plating</label>
            <input type="text" name="forPlating" value={formData.forPlating} onChange={handleChange} className="form-control frm-input-style" placeholder='For plating'/>
          </div>
        </div>
        ...
        <div className="row mb-3">
          <div className="col-md-4">
            ...
            <input type="text" name="underHeatTreatment" value={formData.underHeatTreatment} onChange={handleChange} className="form-control frm-input-style"placeholder='Under heat treatment' />
          </div>
          <div className="col-md-4">
            <label className="form-label clr-label">Under PTFE</label>
            <input type="text" name="underPTFE" value={formData.underPTFE} onChange={handleChange} className="form-control frm-input-style"placeholder='Under PTFE' />
          </div>
          <div className="col-md-4">
            <label className="form-label clr-label">For PTFE</label>
            <input type="text" name="forPTFE" value={formData.forPTFE} onChange={handleChange} className="form-control frm-input-style"placeholder='For PTFE' />
          </div>
        </div>
        ...
        <div className="row mb-3">
          <div className="col-md-4">
            ...
            <input type="text" name="forHeatTreatment" value={formData.forHeatTreatment} onChange={handleChange} className="form-control frm-input-style" placeholder='For heated treatment'/>
          </div>
          <div className="col-md-4">
          ...
          <div className="col-md-4">
            ...
            <input type="text" name="sortedRejected" value={formData.sortedRejected} onChange={handleChange} className="form-control frm-input-style"placeholder='Sorted rejected '/>
          </div>
        </div>
