        ...
        <form onSubmit={handleSubmit}>
          <div className="row mb-3">
            ...
            <div className="col-md-4">
              ...
              <input type="number" name="coreCSKDone" value={formData.coreCSKDone} onChange={handleChange} className="form-control frm-input-style"placeholder='Core CSK done in Quantity' />
            </div>
          </div>
          ...
          <div className="row mb-3">
            <div className="col-md-4">
              ...
              <input type="number" name="coreVisualDone" value={formData.coreVisualDone} onChange={handleChange} className="form-control frm-input-style" placeholder='Core visual done in Quantity'/>
            </div>
            <div className="col-md-4">
              <label className="form-label clr-label">Magnetic Core Drill (in Quantity)</label>
              <input type="number" name="magneticDrill" value={formData.magneticDrill} onChange={handleChange} className="form-control frm-input-style"placeholder='Magnetic core drill in Quantity' />
            </div>
            <div className="col-md-4">
              <label className="form-label clr-label">Magnetic Core Visual Done (in Quantity)</label>
              <input type="number" name="magneticVisual" value={formData.magneticVisual} onChange={handleChange} className="form-control frm-input-style"placeholder='Magnetic core visual done in Quantity' />
            </div>
       
            <div className="col-md-4 mt-3">
              <label className="form-label clr-label">Pivot Pin SS PIP Done (in Quantity)</label>
              <input type="number" name="pivotPin" value={formData.pivotPin} onChange={handleChange} className="form-control frm-input-style"placeholder='Pivot pin SS PIP done in Quantity' />
            </div>
